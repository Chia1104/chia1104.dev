...
> = (MDXPreProps) => {
  ...
  return (
    <div className="group relative">
      ...
      <pre
        {...rest}
        className="text:black scrollbar-thin scrollbar-thumb-secondary scrollbar-thumb-rounded-full dark:bg-code my-7 w-full overflow-x-auto rounded-xl bg-[#dddddd] p-4 transition ease-in-out dark:text-white"
        ref={ref}>
        {children}
      </pre>
    </div>
...
> = (MDXCodeOrionProps) => {
  ...
  return (
    <code
      {...rest}
      className="text:black dark:bg-code overflow-x-auto rounded bg-[#dddddd] p-0.5 transition ease-in-out dark:text-white">
      {children}
    </code>
  );
};
