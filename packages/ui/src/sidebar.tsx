...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      isIconOnly
      className={cn("size-7 group-data-[collapsible=icon]:mx-auto", className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
...
function SidebarInput({
  ...
  return (
    <Input
      ...
      data-sidebar="input"
      className={cn(
        "bg-background h-8 w-full shadow-none group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
    />
...
function SidebarSeparator({
  ...
  return (
    <Separator
      ...
      className={cn(
        "bg-sidebar-border mx-2 w-auto group-data-[collapsible=icon]:mx-auto group-data-[collapsible=icon]:w-8",
        className
      )}
      {...props}
    />
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "group-data-[collapsible=icon]:pointer-events-none group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:opacity-0",
        className
      )}
      {...props}
    />
...
function SidebarMenuButton({
  ...
  const button = (
    <Comp
      ...
      className={cn(
        !asChild ? sidebarMenuButtonVariants({ variant, size }) : "",
        className
      )}
      {...props}
    />
...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      className={cn(
        "flex h-8 items-center gap-2 rounded-md px-2 group-data-[collapsible=icon]:size-8 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:p-2",
        className
      )}
      {...props}>
      {showIcon && (
