...
export const profileContract = {
  list: listProfileEntriesContract,
  get: getProfileEntryContract,
  create: createProfileEntryContract,
  update: updateProfileEntryContract,
  remove: removeProfileEntryContract,
};
