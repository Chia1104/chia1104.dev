...
ALTER TABLE "chia_member" ADD CONSTRAINT "chia_member_user_id_chia_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."chia_user"("id") ON DELETE cascade ON UPDATE no action;