...
export const apikeyRouter = contractOS.apikey.router({
  create: createAPIKeyRoute,
  list: getAllApiKeysWithMetaRoute,
  revoke: revokeApiKeyRoute,
  delete: deleteApiKeyRoute,
  update: updateApiKeyRoute,
});
