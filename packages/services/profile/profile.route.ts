...
import type { ProfileEntryView } from "./profile.contract";
...
export const profileRouter = contractOS.profile.router({
  list: listProfileEntriesRoute,
  get: getProfileEntryRoute,
  create: createProfileEntryRoute,
  update: updateProfileEntryRoute,
  remove: removeProfileEntryRoute,
});
