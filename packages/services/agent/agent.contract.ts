...
import { agentAdminContract } from "./admin.contract";
import {
...
export const agentContract = {
  sessions: {
    list: listAgentSessionsContract,
    create: createAgentSessionContract,
    get: getAgentSessionContract,
    delete: deleteAgentSessionContract,
    "settings:update": updateAgentSessionSettingsContract,
    chat: chatAgentContract,
    abort: abortAgentContract,
    approve: approveAgentToolContract,
    compact: compactAgentSessionContract,
    navigate: navigateAgentSessionContract,
    fork: forkAgentSessionContract,
  },
  models: {
    list: listAgentModelsContract,
  },
  capabilities: {
    list: listAgentCapabilitiesContract,
  },
  usage: {
    me: getAgentUsageContract,
  },
  admin: agentAdminContract,
};
