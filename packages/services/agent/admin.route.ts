...
import type { AgentAdminCaller } from "./admin";
import { requireAgentFactory } from "./agent.service";
...
export const agentAdminRouter = contractOS.agent.admin.router({
  kinds: {
  ...
  tasks: {
    ...
    update: updateAgentTaskAdminRoute,
    models: listAgentTaskModelsAdminRoute,
  },
  quota: {
    get: getAgentQuotaAdminRoute,
    update: updateAgentQuotaAdminRoute,
  },
  usage: {
    week: getAgentUsageWeekAdminRoute,
    user: getAgentUserUsageAdminRoute,
  },
});
