...
import { agentAdminRouter } from "./admin.route";
import {
  agentCallerOf,
  agentKindGuard,
  agentSessionGuard,
...
export const agentRouter = contractOS.agent.router({
  sessions: {
    list: listAgentSessionsRoute,
    create: createAgentSessionRoute,
    get: getAgentSessionRoute,
    delete: deleteAgentSessionRoute,
    "settings:update": updateAgentSessionSettingsRoute,
    chat: chatAgentRoute,
    abort: abortAgentRoute,
    approve: approveAgentToolRoute,
    compact: compactAgentSessionRoute,
    navigate: navigateAgentSessionRoute,
    fork: forkAgentSessionRoute,
  },
  models: {
    list: listAgentModelsRoute,
  },
  capabilities: {
    list: listAgentCapabilitiesRoute,
  },
  usage: {
    me: getAgentUsageRoute,
  },
  admin: agentAdminRouter,
});
