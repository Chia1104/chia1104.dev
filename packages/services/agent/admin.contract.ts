...
export const agentAdminContract = {
  kinds: {
  ...
  tasks: {
    ...
    update: updateAgentTaskAdminContract,
    models: listAgentTaskModelsAdminContract,
  },
  quota: {
    get: getAgentQuotaAdminContract,
    update: updateAgentQuotaAdminContract,
  },
  usage: {
    week: getAgentUsageWeekAdminContract,
    user: getAgentUserUsageAdminContract,
  },
};
