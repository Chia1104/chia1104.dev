...
/** Every write re-indexes; the route hands the hook to `memory/write.service.ts`. */
...
export const memoryContract = {
  list: listMemoriesContract,
  get: getMemoryContract,
  update: updateMemoryContract,
  remove: removeMemoryContract,
  "lesson:approve": approveLessonContract,
  consolidate: consolidateMemoryContract,
};
