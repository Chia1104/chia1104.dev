...
export const ragContract = {
  overview: getRagOverviewContract,
  "chunks:list": listRagChunksContract,
  "chunk:get": getRagChunkContract,
  "resource:status": getResourceIndexStatusContract,
  "runs:list": listIndexRunsContract,
  "run:get": getIndexRunContract,
  "reindex:all:preview": previewReindexAllContract,
  "resource:index": indexResourceContract,
  "feed:index": indexFeedContract,
  "reindex:all": reindexAllContract,
  "embeddings:prune": pruneEmbeddingsContract,
};
