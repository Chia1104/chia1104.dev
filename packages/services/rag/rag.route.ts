...
import {
  ...
  snapshotOfIndexRun,
  triggerIndexRun,
} from "./index-run.service";
import type { IndexRunCaller } from "./index-run.service";
...
export const ragRouter = contractOS.rag.router({
  overview: getRagOverviewRoute,
  "chunks:list": listRagChunksRoute,
  "chunk:get": getRagChunkRoute,
  "resource:status": getResourceIndexStatusRoute,
  "runs:list": listIndexRunsRoute,
  "run:get": getIndexRunRoute,
  "reindex:all:preview": previewReindexAllRoute,
  "resource:index": indexResourceRoute,
  "feed:index": indexFeedRoute,
  "reindex:all": reindexAllRoute,
  "embeddings:prune": pruneEmbeddingsRoute,
});
