...
export const spotifyRouter = contractOS.spotify.router({
  playlist: getSpotifyPlaylistRoute,
  playing: getSpotifyNowPlayingRoute,
  accounts: getSpotifyAccountsRoute,
  authorize: createSpotifyAuthorizationRoute,
  activate: activateSpotifyAccountRoute,
  disconnect: disconnectSpotifyAccountRoute,
});
