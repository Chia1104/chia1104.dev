...
<Image src="/posts/example-post/example.jpg" alt={"Example image"} />
  ...
  return (
    <Layout title={frontMatter.title} description={frontMatter.excerpt}>
      <div className="main c-container mt-5 px-5">
        ...
        <div className="c-bg-secondary content mx-auto mt-5 w-full self-center rounded-xl p-5 lg:ml-2 lg:w-[80%] lg:self-start">
