...
/**
 * Captcha, then a provider. Signing in links the guest's sessions and spend to the account
 * on the server (`onLinkAccount`), so nothing is lost or reset.
 */
export const SignInProviders = ({ className }: { className?: string }) => {
