...
export const selectAllReposLoading = (state: AppState) =>
  state.github.allRepos.loading;
export const selectAllReposError = (state: AppState) =>
  state.github.allRepos.error;
